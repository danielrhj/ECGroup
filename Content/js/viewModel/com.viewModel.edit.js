...
com.viewModel.edit = function (data) {
    ...
    this.saveClick = function () {
        ...
        com.ajax({
            ...
            success: function (d) {
                ...
                if (!isNaN(d.form.RowNo))//新增資料時重新從DB獲取數據
                {
                    //data.dataSource.pageData = d;
                    ko.mapping.fromJS(d, self.pageData);//再次綁定頁面，注意是用d來更新self
                    return;
                    
                } //根據返回值更新Self，再更新頁面，錯誤寫法：self.pageData.form.RowNo=d.form.RowNo;
                ko.mapping.fromJS(self.pageData, {}, data.dataSource.pageData);//更新旧值 data.dataSource.pageData.form
    ...
    this.fnEditGrid = function (tab,grid, edit, i) {
        ...
        //this.saveRowClick = function () {
        //    edit.ended();
        //    var post = { list: edit.getChanges() };
        //    if (edit.isChangedAndValid()) {
        //        com.ajax({
