...
function viewModel() {
    ...
    this.saveClick = function () {
        ...
        var post = {};
        post.list = new com.editTreeGridViewModel(self.grid).getChanges(['_id', 'MenuName', 'MenuCode', 'ParentCode', 'IconClass', 'URL', 'IsVisible', 'IsEnable', 'MenuSeq','MenuLevel']);
            ...
            this.manageClick = function () {
                com.dialog({
                    ...
                    viewModel: function (w_sub) {
                        ...
                        this.gridEdit = new com.editGridViewModel(this.grid);//此方法在common.js裏面
                        ...
                        this.confirmClick = function () {
                            ...
                            var list = that.gridEdit.getChanges(['ButtonCode', 'ButtonName', 'ButtonIcon', 'ButtonSeq', 'Description', 'ColWidth']);
                            com.ajax({
