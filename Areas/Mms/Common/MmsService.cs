...
namespace ECGroup.Areas.Mms.Common
{
    ...
    public class MmsService : ServiceBase<ModelBase>
    {
        ...
        {
            var defaultProject = "ECGroup";
            var projectName = "ECGroup";// (new mms_projectService().GetModel(ParamQuery.Instance().AndWhere("ProjectCode", defaultProject)) ?? new mms_project()).ProjectName;
