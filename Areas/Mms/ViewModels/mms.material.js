...
var mms = mms || {};
mms.material = mms.material || {};

mms.material.viewModel = function () {
    var self = this;
    this.grid = {
        size: { w: 239, h: 40 },
    ...
    this.tree = {
        ...
        queryParams: ko.observable(),
        loadFilter: function (d) {  //d代表url返回的内容(ExpandoObject)：select * from mms_materialType，
    ...
    //点节点時執行一下兩行，并執行ApiController裡面的Get方法
